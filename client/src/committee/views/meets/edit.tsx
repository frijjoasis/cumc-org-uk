...
interface EditMeetProps extends RouterProps {
  location: {
    pathname: string;
    [key: string]: any;
  };
...
interface EditMeetState {
  content: Partial<MeetContent>;
  newID?: string;
  err?: string;
}

class EditMeet extends React.Component<EditMeetProps, EditMeetState> {
  constructor(props: EditMeetProps) {
    super(props);
    this.state = {
      content: {
        questions: [],
...
export default withRouter(EditMeet);
