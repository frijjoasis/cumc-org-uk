...
class Webmaster extends React.Component<WebmasterProps, WebmasterState> {
  constructor(props: WebmasterProps) {
    super(props);
    this.state = {
      content: [],
      err: null,
              ...
              <Card>
                <Card.Body>
                  ...
                  <Card.Subtitle>
                    ...
                    . You{' '}
                    {this.props.member &&
                    this.props.member.committee === 'root' ? (
                  ...
                  <hr />
                  <Button
                    onClick={() => this.resetMemberships()}
                    variant="danger"
                    className="btn-fill w-100"
                    style={{ fontWeight: 'bold' }}
                  >
                    Reset ALL Memberships (NOAH DO NOT TOUCH)
                  </Button>
                </Card.Body>
              </Card>
            </Col>
