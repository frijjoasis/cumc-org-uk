...
import { UserWithProfile } from '@cumc/shared-types';
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <CardDescription className="text-zinc-500 font-medium">
                Manage and view all registered users. Use the search to filter
                by name, college, or membership status.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="rounded-md border border-zinc-200 overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-zinc-50 border-b border-zinc-200">
                <tr>
                  <th className="px-4 py-3 text-left font-bold text-zinc-700 uppercase tracking-wider text-[11px]">
                    Name
                  </th>
                  <th className="px-4 py-3 text-left font-bold text-zinc-700 uppercase tracking-wider text-[11px]">
                    College
                  </th>
                  <th className="px-4 py-3 text-center font-bold text-zinc-700 uppercase tracking-wider text-[11px]">
                    Status
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-200 bg-white">
                {loading ? (
                      ...
                      <td className="px-4 py-4">
                        <div className="flex justify-center">
                          {u.member?.hasPaid ? (
                            ...
                            <Badge
                              variant="outline"
                              className="text-zinc-400 border-zinc-200 gap-1 rounded-full px-3"
                            >
                  ...
                  <tr>
                    <td
                      colSpan={3}
                      className="px-4 py-12 text-center text-zinc-500 italic"
                    >
