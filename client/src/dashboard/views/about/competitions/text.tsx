...
const competitionsAbout = [
  <p>
    Here you can learn more about the competitions we'll be running and taking
    part in over the year. Further information on all these events will be
    released nearer the time, and the calendar will be regularly updated for
  ...
  <p>
    ...
    them off as you go and write whether or not you did it on your first attempt
    too. You'll have a few weeks to try all the climbs and get as many done as
    you can. Once you've finished, submit your score as the score sheet
    instructs. The results will be announced shortly after the competition
    period has ended. There will be a large range in the difficulty of the
  ...
  <p>
    ...
    Lent term. There is no limit to how many people we can enter, so let's get
  ...
  <p>
    ...
    each gender). The usual plan is to take the train down together, compete,
  ...
  <p>
    ...
    serious competition, and club members will gain most from the experience if
    they are regular competitors.
  </p>,
];
