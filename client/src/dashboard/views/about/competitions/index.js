                    ...
                    <Row className="justify-content-center">
                        <Col md={8}>
                            <Card>
                                ...
                                <Card.Footer className="text-center text-muted">Our competitions team training hard</Card.Footer>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row className="justify-content-center">
                        <Col md={6}>
                            <Card>
                                ...
                                <Card.Footer className="text-center text-muted">LUBE 2022</Card.Footer>
                            </Card>
                        </Col>
                        <Col md={6}>
                            <Card>
                                <Image src={img3} fluid />
                                <Card.Footer className="text-center text-muted">Tilly and Lauren crushing in team training</Card.Footer>
                            </Card>
                        </Col>
                    </Row>
                </Container>
