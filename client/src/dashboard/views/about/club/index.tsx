...
class ClubAbout extends React.Component<ClubAboutProps, ClubAboutState> {
  constructor(props: ClubAboutProps) {
    super(props);
    this.state = {
      content: {
        head: [],
            ...
            <Col md={12}>
              <Card>
                <Card.Body>
                  ...
                  <Card.Subtitle>
                    This is a list of some of the routes first climbed by CUMC
                    members.
                  </Card.Subtitle>
                  <hr />
