                ...
                <Tab.Container id="tabs-documents" defaultActiveKey="safety">
                  <Card.Header>
                    <Nav variant="tabs" defaultActiveKey="details">
                      ...
                      <Nav.Item>
                        <Nav.Link eventKey="codeOfConduct">
                          Code of Conduct
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                      ...
                      <Nav.Item>
                        <Nav.Link eventKey="constitution">
                          Constitution
                        </Nav.Link>
                      </Nav.Item>
                      <Nav.Item>
                        <Nav.Link eventKey="wherryDonation">
                          Wherry Donation Policy
                        </Nav.Link>
                      </Nav.Item>
                    </Nav>
                  </Card.Header>
                  <Card.Body>
                    <Tab.Content>
                      ...
                      <Tab.Pane eventKey="codeOfConduct">
                        <Card.Text as="span">{codeOfConductAbout}</Card.Text>
                      </Tab.Pane>
                      <Tab.Pane eventKey="welfare">
                        <Card.Text as="span">{welfareAbout}</Card.Text>
                      </Tab.Pane>
                      ...
                      <Tab.Pane eventKey="constitution">
                        <Card.Text as="span" className="legallist">
                          {constitutionAbout}
                        </Card.Text>
                      </Tab.Pane>
                      <Tab.Pane eventKey="wherryDonation">
                        ...
                        <Card.Subtitle>
                          How to donate books to the club library
                        </Card.Subtitle>
                        <Card.Text as="span">
                          <hr />
