...
class CommitteeAbout extends React.Component<
  ...
  CommitteeAboutState
> {
  constructor(props: CommitteeAboutProps) {
    super(props);
    this.state = {
      currentCommittee: [],
      pastCommittees: {
  ...
  renderCommitteeMember = (member: Committee, key: number) => {
                ...
                <Card.Body>
                  ...
                  {currentCommittee.length === 0 ? (
                    <p className="text-center">
                      No current committee members found.
                    </p>
                  ) : (
            ...
            <Col md={12}>
              <Card>
                ...
                <Card.Footer className="text-center text-muted">
                  The current committee members, at the 2024 Annual General
                  Meeting
                </Card.Footer>
              </Card>
            </Col>
