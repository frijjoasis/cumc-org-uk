...
const outdoorMeets = [
  ...
  <p className="mt-6 mb-2 text-zinc-900">
    ...
    whole day, leaving at 0700 sharp and get back in the evening sometime,
    depending on the time of year. We’ll look at the preferences of those that
  ...
  <p className="mt-6 mb-2 text-zinc-900">
    ...
    these trips so we don’t need to camp. As well as some fantastic climbing,
    you can expect a nice meal and lots of bunkhouse fun and games! The
    ever-popular sock wrestling or table mountaineering are bound to make an
    appearance at some point over the weekend! We also now have a special CUMC
  ...
  <p className="mt-6 mb-2 text-zinc-900">
    ...
    it’s possible or not depends on if there’s room in the car for a boulder
    pad! If you’re a super keen sport climber let us know and we’ll see if we
  ...
  <p className="mt-6 mb-2 text-zinc-900">
    ...
    need though: generally indoor meets are a good time for this. If you want to
    learn to lead trad then we’re happy to show you (we usually run one meet per
    term geared towards this), but it’s definitely best if you learn to lead
  ...
  <p className="mt-6 mb-2 text-zinc-900">
    ...
    find you can no longer go then email the organiser BEFORE 10AM on the Friday
    and they will refund you. No refunds will be given after this time except in
    exceptional circumstances. If the entire meet is cancelled then everyone
    will be refunded.
  </p>,
  <br />,
  <h3 className="text-2xl font-black uppercase italic tracking-tight text-zinc-900 mt-12 mb-4">
  ...
  <p className="mt-6 mb-2 text-zinc-900">
    ...
    clothes, sturdy shoes, lunch etc.). If you have climbing gear, such as your
    own rack or rope, that you’re prepared to use then please bring them along.
    The club have some gear that can be lent to members, but if you have your
    own then you’re likely to want to use it anyway! However you use personal
    gear on meets at your own risk; the club won't cover the cost of damage or
    loss.
  </p>,
];
