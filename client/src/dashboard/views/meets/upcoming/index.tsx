...
interface UpcomingMeetsProps {
  user: User;
}
interface UpcomingMeetsState {
  content: any;
}
...
class UpcomingMeets extends React.Component<
  ...
  UpcomingMeetsState
> {
  constructor(props: UpcomingMeetsProps) {
    super(props);
    this.state = {
      content: [],
    };
    ...
    return (
      <div className="content">
        {this.props.user ? null : (
          <Alert variant="dark">
            You will need to <NavLink to="/login">sign in</NavLink> and register
            before you can sign up to meets!
          </Alert>
        )}
        <Container>
