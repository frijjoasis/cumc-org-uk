...
import { RouterProps, withRouter } from '@/utils/withRouter';
...
class ViewMeet extends React.Component<ViewMeetProps, ViewMeetState> {
  ...
  componentDidMount() {
    axios
      .post('/api/meets/view', { id: this.props.router.params.id })
      .then(res => {
        if (res.data.err) {
              ...
              <Card>
                <Card.Body>
                  ...
                  <Card.Text as="span">
                    ...
                    {this.props.user
                      ? `The emergency contact for this meet is 
                    ...
                    <Table striped bordered hover responsive>
                      ...
                      <tbody>
                        ...
                        this.state.content.signups.length ? (
                          ...
                          <tr>
                            <td className="text-center">None yet!</td>
                          </tr>
                        )}
                      </tbody>
                    </Table>
