...
const Admin = lazy(() => import('./committee/index'));
...
root.render(
  <React.StrictMode>
    ...
    >
      <Suspense
        fallback={
          <div className="h-screen w-screen flex items-center justify-center font-black italic text-zinc-400 animate-pulse">
            LOADING CUMC DASHBOARD...
          </div>
        }
      >
        <Routes>
