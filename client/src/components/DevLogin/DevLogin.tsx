...
class DevLogin extends Component<DevLoginProps, DevLoginState> {
  constructor(props) {
    super(props);
    this.state = {
      devMode: false,
  ...
  render() {
    const { devMode, authenticated, user, message, loading, adminBypass } =
      this.state;
              ...
              <Card.Body>
                ...
                {!authenticated ? (
                  ...
                  <>
                    ...
                    <p>
                      You now have full admin access to committee management
                      features.
                    </p>
                    <Button variant="primary" href="/committee">
                ...
                <small className="text-muted">
                  <strong>Note:</strong> This bypass only works in development
                  mode and will not be available in production.
                </small>
              </Card.Body>
            </Card>
          </Col>
