...
type Ascent = [string, string, string, string];

const firstAscents: {
  head: ['Date', string, 'Grade', 'Location'];
  body: Ascent[];
} = {
  ...
  body: [
    ...
    [
      '1931, 10 Jul',
      'Square Chimney Buttress',
      'Severe',
      'East Buttress, Glyder Fach',
    ],
    ...
    [
      '1957, 21 Jun',
      'The Ruritanian Climb',
      'Severe',
      'Garadh Na Ciste, Ben Nevis',
    ],
    ['', 'CUMC Party', '', ''],
    ...
    [
      '1972, 1 Jul',
      'The Sand Piper dir. Finish',
      'HVS',
      'The Stag Rocks, Cairngorms',
    ],
    ['', 'M.G. Geddes, J.C. Higham', '', ''],
    ...
    [
      '1978, 25 Mar',
      'The Six-track Mono Blues',
      'II',
      'Meall Gorm, Applecross',
    ],
    ...
    [
      ...
      'VS 4c,4b',
      'Tyn Towyn Quarries, Lleyn Peninsula',
    ],
    ['', 'B. Davison, R. Delaney', '', ''],
    ...
    [
      '1986, 26 Jul',
      'All Your Seasick Boaties, They Are Rowing Home',
      'Hard Difficult',
    ...
    [
      '1986, 21 Sep',
      'Antartic Caterpillar',
      'E1 5c',
      'Bulgham Bay, Isle of Man',
    ],
    ['', 'B. Davison, A. Smith', '', ''],
